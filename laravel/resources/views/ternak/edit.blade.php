            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('ternak.update',['ternak' => $ternak->id]) }}" method="POST">
                            @method('PATCH')
                            @csrf
                                <div class="form-group">
                                    <label for="ras">Ras</label>
                                    <input type="text" class="form-control @error('ras') is-invalid @enderror"
                                    id="ras" name="ras" value="{{ old('ras') ?? $ternak->ras }}">
                                    @error('ras')
                                ...
                                <div class="form-group">
                                    ...
                                    id="nama" name="nama" value="{{ old('nama') ?? $ternak->nama }}">
                                    @error('nama')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    id="umur" name="umur" value="{{ old('umur') ?? $ternak->umur }}">
                                    @error('umur')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    id="berat" name="berat" value="{{ old('berat') ?? $ternak->berat }}">
                                    @error('berat')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="jeniskelamin" id="jeniskelamin" class="form-control">
                                            <option value=""{{ (old('jeniskelamin') ?? $ternak->jeniskelamin)==
                                            'pilih' ? 'selected': '' }} > pilih</option>
                                            <option value="Laki-laki"{{ (old('jeniskelamin') ?? $ternak->jeniskelamin)==
                                            'Laki-laki' ? 'selected': '' }} > Laki-laki</option> 
                                            <option value="Perempuan"{{ (old('jeniskelamin') ?? $ternak->jeniskelamin)==
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control @error('status') is-invalid @enderror"
                                    id="status" name="status" value="{{ old('status') ?? $ternak->status }}">
                                    @error('status')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror  
                                </div>
                                <button type="submit" class="btn btn-primary">Upload</button>
                                <a href="{{ route('ternak.index') }}" class="btn btn-primary">Kembali</a></br>
                              </form>
                        </div>
                    </div>
