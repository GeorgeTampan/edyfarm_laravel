                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('penjualan.store') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('pembeli') is-invalid @enderror"
                                                    id="pembeli" name="pembeli" value="{{ old('pembeli') }}">
                                                    @error('pembeli')
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select id="metode" name="metode" class="form-control">
                                                        ...
                                                        {{ old('metode')=='Pilih' ? 'selected': '' }} >
                                                        Pilih
                                                        <option value="Tunai">Tunai</option>
                                                        {{ old('metode')=='Tunai' ? 'selected': '' }} >
                                                        Tunai
                                                        <option value="Debit">Debit</option>
                                                        {{ old('metode')=='Debit' ? 'selected': '' }} >
                                                        Debit
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control @error('kembali') is-invalid @enderror"
                                                    id="kembali" name="kembali" value="{{ old('kembali') }}">
                                                    @error('kembali')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
