                            ...
                            <table class="table table-striped">
                                ...
                                @forelse ($hutang as $hutang)
                                    <tr>
                                        ...
                                        <td>{{$hutang->kurang}}</td>
                                        <td>
                                        <form action="{{ route('hutang.destroy',['hutang'=>$hutang->id]) }}"  method="POST">
                                        @method('DELETE')
                                        @csrf
                              ...
                              <nav aria-label="Page navigation example">
                                <a href="{{ route('hutang.create') }}"><button class="btn btn-info me-3"><i class="fas fa-plus"></i> Tambah Daftar Hutang</button></a>
